...
let { getRandomVideos } = require('../dao/videoDao');
let fs = require('fs');
let {query, downloadMp4} = require('../api/youtubeApi');
...
let SCREEN_BASE_URL = 'http://yongwang.space:7000/Videos/video_thumbnails/'
